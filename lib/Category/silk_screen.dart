...
class SilkScreen extends StatefulWidget {
  ...
  @override
  State<SilkScreen> createState() => _SilkScreenState();
}
...
class _SilkScreenState extends State<SilkScreen> {
  ...
  Future<void> loadProducts() async {
    ...
    silkCategory = categories.firstWhere((cat) => cat.name == 'Silk');
    List<Product> fetchedProducts =
        await dbHelper.getProductsByCategory(silkCategory!.id!);
    setState(() {
