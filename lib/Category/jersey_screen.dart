...
class JerseyScreen extends StatefulWidget {
  const JerseyScreen({super.key});

  @override
  State<JerseyScreen> createState() => _JerseyScreenState();
}

class _JerseyScreenState extends State<JerseyScreen> {
  ...
  Future<void> loadProducts() async {
    ...
    jerseyCategory = categories.firstWhere((cat) => cat.name == 'Jersey');
    List<Product> fetchedProducts =
        await dbHelper.getProductsByCategory(jerseyCategory!.id!);
    setState(() {
