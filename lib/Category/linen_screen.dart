...
class LinenScreen extends StatefulWidget {
  const LinenScreen({super.key});

  @override
  State<LinenScreen> createState() => _LinenScreenState();
}

class _LinenScreenState extends State<LinenScreen> {
  ...
  Future<void> loadProducts() async {
    ...
    linenCategory = categories.firstWhere((cat) => cat.name == 'Linen');
    List<Product> fetchedProducts =
        await dbHelper.getProductsByCategory(linenCategory!.id!);
    setState(() {
