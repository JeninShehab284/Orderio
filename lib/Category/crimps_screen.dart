...
class CrimpsScreen extends StatefulWidget {
  const CrimpsScreen({super.key});

  @override
  State<CrimpsScreen> createState() => _CrimpsScreenState();
}

class _CrimpsScreenState extends State<CrimpsScreen> {
  ...
  Category? crimpsCategory;

  Future<void> loadProducts() async {
    List<Category> categories = await dbHelper.getCategories();
    crimpsCategory = categories.firstWhere((cat) => cat.name == 'Crimps');
    List<Product> fetchedProducts =
        await dbHelper.getProductsByCategory(crimpsCategory!.id!);
    setState(() {
