...
class CottonScreen extends StatefulWidget {
  ...
  @override
  State<CottonScreen> createState() => _CottonScreenState();
}

class _CottonScreenState extends State<CottonScreen> {
  final DBHelper dbHelper = DBHelper();
  List<Product> products = [];
  bool isLoading = true;
  Category? cottonCategory;
  ...
  Future<void> loadProducts() async {
    ...
    cottonCategory = categories.firstWhere((cat) => cat.name == 'Cotton');
    List<Product> fetchedProducts =
        await dbHelper.getProductsByCategory(cottonCategory!.id!);
    setState(() {
