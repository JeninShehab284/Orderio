...
import 'package:orderio/main.dart';

class ChiffonScreen extends StatefulWidget {
  const ChiffonScreen({super.key});

  @override
  State<ChiffonScreen> createState() => _ChiffonScreenState();
}

class _ChiffonScreenState extends State<ChiffonScreen> {
  final DBHelper dbHelper = DBHelper();
  List<Product> products = [];
  bool isLoading = true;
  Category? chiffonCategory;
  ...
  Future<void> loadProducts() async {
    ...
    chiffonCategory = categories.firstWhere((cat) => cat.name == 'Chiffon');
    List<Product> fetchedProducts =
        await dbHelper.getProductsByCategory(chiffonCategory!.id!);
                ...
                IconButton(
                  onPressed: () async {
                    ...
                    if (product.id != null) {
                      ...
                      await dbHelper.insertToCart(productWithImage, customerId);
                      setState(() {
